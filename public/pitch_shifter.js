/*
Code taken from: https://github.com/Collaboarator/ShortTimeFourierPitchShifterJS/blob/master/Example.html
Its license: MIT https://github.com/Collaboarator/ShortTimeFourierPitchShifterJS/blob/master/LICENSE
*/
...
function PitchShift(/* float[*/ pitchShift, /* long */ numSampsToProcess, /* long */ fftFrameSize,
    ...
    /* double */
    let magn, phase, tmp, window, real, imag;
    /* double */
    let freqPerBin, expct;
    /* long */
    let i, k, qpd, index, inFifoLatency, stepSize, fftFrameSize2;
...
function ShortTimeFourierTransform(/* float[] */ fftBuffer, /* long */ fftFrameSize, /* long */ sign) {
    ...
    /* long */
    let max = /* (long) */Math.trunc(Math.log(fftFrameSize) / Math.log(2.0) + .5);
